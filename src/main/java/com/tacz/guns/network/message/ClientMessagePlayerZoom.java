...
public class ClientMessagePlayerZoom implements FabricPacket {
    public static final PacketType<ClientMessagePlayerZoom> TYPE = PacketType.create(new ResourceLocation(GunMod.MOD_ID, "c2s_player_zoom"), ClientMessagePlayerZoom::new);
